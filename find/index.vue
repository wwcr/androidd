...
<style scoped lang='scss'>
    ...
    .right {
        background: url(../../../src/assets/img/img_46.jpg) no-repeat;
        position: absolute;
        top: 0;
        right: 0;
        padding-left: 1.3rem;
...
<script type="text/javascript">
    ...
    import manager from './Executive/manager'
    import ordinary from './Executive/ordinary'
    ...
    export default {
        ...
        created: function () {
            ...
            // this.Http('index/index/userOrderList',{
            //     use_id: 6,
            // },function (res) {
            //     console.log(res)
            // })
