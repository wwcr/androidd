<template lang="html">
    <div class="yo-scroll" :class="{'down':(state===0),'up':(state==1),refresh:(state===2),touch:touching}" @touchstart="touchStart($event)" @touchmove="touchMove($event)" @touchend="touchEnd($event)">
        <section class="inner" :style="{ transform: 'translate3d(0, ' + top + 'px, 0)' }">
            ...
            <footer class="load-more-main">
                <slot name="load-more-main">
                    <span v-show="downFlag === false"></span>
                    <span v-show="downFlag === true"></span>
                </slot>
            </footer>
...
<style lang="less">
    @import url("../assets/style/pull-refresh_message.less");
</style>
<script>
    export default {
        props: {
        ...
        methods: {
            touchStart(e) {
                ...
                this.$el.querySelector('.load-more-main').style.display = 'none';
            },
            touchMove(e) {
