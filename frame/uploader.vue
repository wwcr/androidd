<template>
  <div class="imgUploader">
    <input type="text" class="forum-title" v-model="forum.title" placeholder="标题">
    <input type="text" class="forum-content" v-model="forum.content" placeholder="内容">
    <div class="file-list">
      <section
...
export default {
  ...
  methods: {
    ...
    submit () {
      ...
      formData.append('content', this.forum.content);
      formData.append('uid', cookie.get('user_id'));
      // 新建请求
...
.imgUploader  {
  ...
  .add {
    ...
    font-size: 30px;
    cursor: pointer;
    border: 1px dashed #b6b2b2e5;
    // color: @sub_color;
    position: relative;  
    background: url(../../assets/img/license_bg.png) center;
    .fa {
      font-size: 1.4em;
      color: #7DD2D9;
    }
